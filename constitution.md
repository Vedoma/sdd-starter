...
| Version | Date | Change |
| --- | --- | --- |
| 1.0 | (unreleased) | Initial constitution: principles C1-C9, each with an enforcement mechanism and a `Status` stating how much of it is actually enforced today. |
...
> exist (C3, C4, C6 and C7 in particular). The cells now say so instead. Releasing 1.0
