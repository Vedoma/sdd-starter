...
skips GitHub's template injection - copy this file and fill it in. A pure revert may instead
carry a visible line citing what it reverts - spec-lint: skip-pr-template - reverts #123 - and
still needs a Spec Reference. Edit this template freely: spec-lint reads it on every run.
-->
